define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/member/stat/index' + location.search,
                    add_url: 'finance/member/stat/add',
                    edit_url: 'finance/member/stat/edit',
                    del_url: 'finance/member/stat/del',
                    multi_url: 'finance/member/stat/multi',
                    import_url: 'finance/member/stat/import',
                    table: 'member_stat',
                }
            });

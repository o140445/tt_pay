define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/wallet/log/index' + location.search,
                    add_url: 'finance/wallet/log/add',
                    edit_url: 'finance/wallet/log/edit',
                    del_url: 'finance/wallet/log/del',
                    multi_url: 'finance/wallet/log/multi',
                    import_url: 'finance/wallet/log/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'type', title: __('Type'), visible: false, searchList: $.getJSON('finance/wallet/log/getChangeType'), formatter: Table.api.formatter.label},
